...
for step=1:iter
    ...
    w1=max(abs_C-alpha1/theta1,0).*C1./abs_C;
    w2=max(abs_C-alpha1/theta1,0).*C2./abs_C;
    ...
    v11=max(abs_S-alpha0/theta2,0).*S1./abs_S;
    v22=max(abs_S-alpha0/theta2,0).*S2./abs_S;
    v3 =max(abs_S-alpha0/theta2,0).*S3./abs_S;
