...
if strcmp(f1,'1') %Condat algorithm
    if strcmp(f2,'1') %Condat SSIM
        ssim_noised_image=ssim(noise_img,GroTru)
        x=ssim_noised_image;
...
title( sprintf('From the left,  GT image,  noised image with SSIM= %.4f,  denoised image with SSIM=  %.4f',x,y ) );
    elseif strcmp(f2,'2') %Condat PSNR
          pnsr_noised_image=psnr(noise_img,GroTru)
          x= psnr_noised_image;
    ...
    elseif strcmp(f2,'3') %Condat MS SSIM
         msssim_noised_image=multissim(noise_img,GroTru)
         x=msssim_noised_image;
    ...
    elseif strcmp(f2,'4') %Condat PSNR HVSM
        psnrhvsm_noised_image=psnrhvsm(noise_img,GroTru)
        x=psnrhvsm_noised_image;
    ...
    elseif strcmp(f2,'5') %Condat PSNR HMA
        psnrhma_noised_image=psnrhma(noise_img,GroTru)
        x=psnrhma_noised_image;
        ...
        fsim_noised_image=FeatureSIM(GroTru,noise_img)
        x=fsim_noised_image;
...
title( sprintf('From the left,  GT image,  noised image with SSIM= %.4f,  denoised image with SSIM=  %.4f', x,y ) );
    elseif strcmp(f2,'2') %FFT PSNR
         psnr_noised_image=psnr(noise_img,GroTru)
         x=psnr_noised_image;
